...
REGLES = [
    ...
    ("23 postulable ≠ attribué ≠ fermé", ["procedure"],
    ...
    ("24 INCONNU n'est jamais promu en POSTULABLE", ["procedure"],
    ...
    ("25 hiérarchie des preuves, contradictions visibles", ["procedure"],
     ["un_statut_declare_bat_la_rubrique_du_portail",
      "un_etat_explicite_bat_la_rubrique_du_portail",
      "deux_preuves_de_meme_rang_contradictoires_donnent_inconnu"]),
    ("26 vocabulaire par source, jamais inventé", ["procedure", "adaptateur"],
    ...
    ("27 négations et formulations indirectes comprises", ["procedure"],
    ...
    ("28 taxonomie d'un portail, rubrique par rubrique", ["procedure"],
     ["les_trois_rubriques_ne_finissent_pas_au_meme_endroit",
      "une_preinformation_va_dans_developper_et_surveille",
      "un_appel_a_projets_n_est_ni_postulable_ni_jete"]),
    ("29 l'état change l'action, jamais le score", ["score", "procedure"],
     ["l_etat_ne_change_pas_le_score", "le_module_ne_connait_aucun_portail",
